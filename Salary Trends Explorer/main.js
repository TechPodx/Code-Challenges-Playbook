...
import {getAverageSalaryByRole, getAverageSalaryByCompany, getSalaryAtCompany, getIndustryAverageSalary} from './modules/TrendsModule.js';
...
function updateResults(){
  ...
  // If either the company or role is unselected, 
  if (!company || !role) { return; }

  // The workAroundModule functions to calculate the needed data.
